...
ALL_TARGETS="rest-api,soap-service,graphql-server,concat-spa"
...
usage() {
    ...
    echo "                     Valid: rest-api,soap-service,graphql-server,concat-spa"
...
main() {
    ...
    # ── Write config ──
    write_config "$REST_API_PORT" "$SOAP_SERVICE_PORT" "$GRAPHQL_SERVER_PORT" "$CONCAT_SPA_PORT" "$targets"
