...
//
// Returns an empty slice (not an error) when no bindings are found.
func ExtractGRPCWebBindings(captured []crawl.ObservedRequest) ([]classify.GRPCService, error) {
	...
	return mergeServices(byService), nil
}
